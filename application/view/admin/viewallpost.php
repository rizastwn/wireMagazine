				...
				<div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
					<div class="row">
						...
						<div class="col-lg-12 animate-box">
							<h3 class="heading">Menampilkan semua post</h3>
								    ...
								    <tbody>	    	
								      ...
								      <tr>
										...
										<td class="col-md-1">
											...
											<form class="form-horizontal" role="form" action="<?php echo URL; ?>admin/hapuspost" method="post" enctype="multipart/form-data">
